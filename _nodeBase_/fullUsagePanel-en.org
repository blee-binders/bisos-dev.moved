...
** ----
** ----
** Towards A Complete, Individual Edge Oriented Digital Ecosystem
...
**** In cs.py global fix all ucf refs and all TM, EH, LOG
**** Cleanup io and and bpf
**** WAITING End to end test with new examples
**** DONE Redo and cleanup inCmnd.py
**** DONE Remove in-cmnds from cs.py
**** WAITING End to end test with new inCmnd.py
**** TODO Redo and cleanup runArgs.py
**** TODO Remove runArgs from cs.py
**** WAITING End to end test with new runArgs.py
**** DONE Redo and cleanup param.py
**** DONE Remove param.py from cs.py
**** WAITING End to end test with new param.py
**** DONE Redo and cleanup arg.py
...
**** Re-visit logging in io
**** Cleanup all of io
**** Cleanup all of bpf
**** Re-do dblocks
**** Build mass transitioner convertIcmToCs.sh
**** -
*** -
