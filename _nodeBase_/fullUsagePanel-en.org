...
*** TODO Complete blee/emacs-developers-requests repo.
*** Use marmee live on multiple machines informally
*** ----P2::  All of above 2 weeks? ---- Due Oct 6, 2022
*** --------------  EmacsConf Begin ------------  Oct 24, 2022
*** TODO Edit summary on wiki, similar to 2021 --- Target Oct 29
*** DONE Verify reveal  machinary from last year
*** TODO Absorb and complete bisos-apps/lcnt panels
*** WAITING Add all the drawings --- Add graphics to latex drawing
*** TODO Start an early 0.1 base. Experiment with voice recordings  --- Target Oct 29
*** TODO Absorbe Sacha's Closed Captioning Tools
*** TODO Complete Video --- Target  November 18
*** TODO Improve latex build machinary along with 120033
*** TODO Drive reveal in parallel with 180051
