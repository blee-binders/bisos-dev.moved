...
*** TODO Machinary-General: Customized .gitignore for lcnt repo-s
*** TODO Machinary-General: Capture shorttitle in dblocks
*** TODO Machinary-General: Automate per chapter pdf generation with TOC --- See Notes
- Automate dblock for creation of includeonly from command line from within chapter
- Add whenComplete vs whenPartial --- Drive them with Controls fileParams
- For when partial import etoc
- Make all the parts be includes, so they don't show up in partial
- Add -p chapters to lcntProc.sh and include them as org-commands in chapter files.
-
***                                       =======================
