...
| [[Phase-3]] | ---        | ---        | 6 wks    | Planned | CS, GitShROP, Pals, Qmail+Jekyl, CleanBoot |
...
*** Render obsoleted saiInMailControl.py --- Replace it with aasInFps.py
*** Rename saiInMailOfflineimap.py to aasInOfflineimap.py
*** Rename marmeeSaiInMail.cs to marmeeAasIn.cs
*** Convert  -- gmailOauth2.cs --- Keep old as gmailOauth2Icm.cs
*** Complete -- gmailOauth2.cs, A full fledged with ins and outs in the marmee space
*** Convert  -- qmail-remote.cs --- Keep old as qmail-remoteIcm.cs
*** Complete marmeeAasIn.cs based on gmailOauth2.cs outputs (imap retreives)
*** Complete qmail-remote.cs based on gmailOauth2.cs outputs
*** Automate continous running of marmeeAasIn.cs
*** Cleanup marmee as package
*** Use marmee live on multiple machines informally
*** ----P2::  All of above 2 weeks? ---- Due Oct 6, 2022
*** --------------  EmacsConf ------------
*** Edit summary on wiki, similar to 2021
*** Verify reveal  machinary from last year
*** Add all the drawings --- Add graphics to latex drawing
*** Start an early 0.1 base. Experiment with voice recordings
*** Improve latex build machinary along with 120033
