...
** Next Steps
*** +
*** Complete ro_fps in ro.py csRos-manage.cs
*** Add menu to fpCls as cmnd
*** Add :ro t to classHead --- Sets up rtInvConstraints and adds roSapPath as pyInv.
*** Test pyInv and pyRoInv
*** Create new snippets for file segments and new dblocks
*** Re-visit convertIcmToCs.sh
*** Cleanup b. b.cs and b.io
*** ===== P1:: All of above 1 week? =====
*** Revive encrypted file params with new CS
*** Revive and complete MARMEE with new CS
*** ----P2::  All of above 2 weeks? ----
